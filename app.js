...
homeTl.from(".red", {x:"-100vw", y: "-100vh", scale: 0, delay: 0.1})
    ...
    .to(".yellow",{x:"-100vw",duration: 3, ease:"power.in", delay:0.1},)
    .to(".red",{x:"200vw",duration: 3, ease:"power.in"},"<")
    .to(".green",{x:"200vw",duration: 3, ease:"power.in"},"<")
    .to(".blue",{x:"-200vw",duration: 3, ease:"power.in"},"<")